      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="reveal reveal-delay-2 text-muted-3 text-[14px] leading-relaxed mb-8">
              {t.about.p2}
            </p>
            ...
            <div className="reveal reveal-delay-4 flex items-center gap-6">
              <a
                href="#projects"
                className="text-[13px] font-semibold text-text underline underline-offset-4 hover:text-accent transition-colors"
              >
          ...
          <div className="relative h-[460px] lg:h-[540px] reveal reveal-delay-1">
            <div className="img-zoom absolute inset-0 rounded-2xl overflow-hidden border border-border">
              <Image
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-overlay-bg-60 via-transparent to-transparent" />
            </div>
            <div className="absolute bottom-6 left-6 bg-overlay-bg-alt-90 backdrop-blur border border-border-2 rounded-xl px-5 py-3">
              <div className="text-[11px] text-muted-3 font-mono mb-1">
                {t.about.currently}
              </div>
