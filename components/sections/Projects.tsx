...
export default function Projects() {
  ...
  const projects = [
    { title: t.projects.p1_title, desc: t.projects.p1_desc, tags: PROJECT_TAGS[0], img: PROJECT_IMAGES[0] },
    { title: t.projects.p2_title, desc: t.projects.p2_desc, tags: PROJECT_TAGS[1], img: PROJECT_IMAGES[1] },
    { title: t.projects.p3_title, desc: t.projects.p3_desc, tags: PROJECT_TAGS[2], img: PROJECT_IMAGES[2] },
  ]

  return (
    <section id="projects" className="bg-[var(--bg-alt)] border-t border-[var(--border)] py-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {projects.map((p, i) => (
            <div key={p.title}
              ...
              <div className="p-6">
                <h3 className="text-[var(--text)] font-bold text-lg mb-2">{p.title}</h3>
                <p className="text-[var(--muted-2)] text-[13px] leading-relaxed mb-5">{p.desc}</p>
