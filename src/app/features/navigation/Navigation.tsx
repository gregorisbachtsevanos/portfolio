...
import MobileNavControls from "./components/mobile/NavControls";
import MobileNavItems from "./components/mobile/NavItems";
...
const Navigation = () => {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between h-14 gap-3 sm:h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-8">
              <NavLinks scrollToSection={scrollToSection} navItems={navItems} />
              <LanguageSwitcher />
              <ThemeToggleButton
                onClick={toggleTheme}
      ...
      {isMobileMenuOpen && (
        <MobileNavItems navItems={navItems} scrollToSection={scrollToSection} />
      )}
    </nav>
  );
};
